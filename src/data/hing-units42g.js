/* Hinglish: the v4.2 hands-on units, part 7 of 7. */
Object.assign(window.HING = window.HING || {}, {

  'This is the bridge between PM delivery and engineering reality.':
    'Yahi PM ki delivery aur engineering ki hakeekat ke beech ka pul hai.',
  'Create a deployment checklist and rollback command/process.':
    'Ek deployment checklist aur wapas lautne ka command ya tareeka banaiye.',
  'Deploy a deliberately bad prompt to staging and verify production remains unchanged.':
    'Jaan-boojh kar ek kharab prompt staging par bhejiye aur dekhiye ki production waisa hi hai.',
  'Environment Strategy + Rollout Checklist.':
    'Environment ki strategy aur rollout ki checklist.',
  'What can change without a code deployment?':
    'Bina code deploy kiye kya-kya badal sakta hai?',
  'Configuration is part of the system and must be versioned.':
    'Configuration system ka hissa hai aur uske bhi version rakhne chahiye.',
  'CI/CD and AI regression':
    'CI/CD aur AI ki giravat',
  'Combine software tests with evaluation gates.':
    'Software ke test ko evaluation ke gate se jodiye.',
  'A green build is not enough if the model behavior regressed.':
    'Hara build kaafi nahi hai agar model ka vyavhaar peechhe khisak gaya ho.',
  'Add deterministic tests plus the golden evaluation suite to CI.':
    'CI mein nishchit test ke saath golden evaluation suite bhi jodiye.',
  'Define blocking thresholds.':
    'Raasta rokne wali seemaayein tay kijiye.',
  'Change model/prompt/index and verify CI detects the regression.':
    'Model, prompt ya index badliye aur dekhiye ki CI giravat pakadta hai.',
  'AI CI/CD Pipeline Spec.':
    'AI ke CI/CD pipeline ka spec.',
  'What evidence is required before release?':
    'Release se pehle kaunsa saboot chahiye?',
  'This is how probabilistic systems become manageable delivery units.':
  ...
  'Include rejected alternatives and evidence.':
    'Thukraye gaye vikalp aur unka saboot bhi rakhiye.',
  'Create a new requirement that invalidates one decision.':
    'Ek nayi zaroorat gadhiye jo kisi ek faisle ko galat sabit kar de.',
  'ADR Set.':
    'ADR ka set.',
  'What would cause you to revisit the decision?':
    'Kya cheez aapse yeh faisla dobara dekhwaayegi?',
  'ADRs protect institutional memory and make technical PM reasoning visible.':
    'ADR sanstha ki yaadaasht bachate hain aur technical PM ki soch ko dikha dete hain.',
  'Vendor and TCO strategy':
    'Vendor aur kul lagat ki strategy',
  'Evaluate provider/model choices across quality, cost, region, data controls, tooling and exit cost.':
    'Provider aur model ke chunaav ko gunvatta, lagat, region, data ke intezaam, tool aur nikalne ki lagat — sab par parkhiye.',
  'Vendor choice is a multi-objective architecture decision.':
    'Vendor chunna kai lakshyon wala architecture ka faisla hai.',
  'Score at least three realistic options or two providers plus a self-hosted hypothesis.':
    'Kam se kam teen vaastavik vikalp, ya do provider aur ek khud-host karne ka anumaan — sab ko score dijiye.',
  'Estimate migration and exit cost.':
    'Badalne aur nikalne ki lagat ka andaaza lagaiye.',
  'Model a 2× price change or capability removal.':
    'Do guna daam badhne ya koi kshamta hat jaane ka model banaiye.',
  'Model/Vendor Scorecard + Exit Plan.':
    'Model aur vendor ka scorecard, aur nikalne ki yojana.',
  'What is the cost of switching?':
    'Badalne ki lagat kitni hai?',
  'Vendor lock-in is an economic and architectural risk.':
    'Kisi ek vendor mein phans jaana paise ka bhi khatra hai aur architecture ka bhi.',
  'Technical decision pack':
    'Technical faislon ka pack',
  'Package the whole system for a design review.':
    'Poore system ko design review ke liye ek pack mein baandhiye.',
  'A strong PM-engineer artifact lets different audiences inspect the same evidence at different depths.':
    'Achhi PM-engineer cheez wahi hai jisse alag-alag log ek hi saboot ko alag-alag gehraai tak dekh sakein.',
  'Create problem, baseline, architecture, alternatives, evaluation, security, cost, rollout and risks.':
    'Samasya, baseline, architecture, vikalp, evaluation, security, lagat, rollout aur khatre — sab banaiye.',
  'Add one architecture diagram and one decision table.':
    'Ek architecture diagram aur ek faisle ki table jodiye.',
  'Ask a reviewer to challenge three assumptions.':
    'Kisi se kahiye ki aapke teen anumaanon par sawaal uthaye.',
  '10-slide Technical Decision Pack.':
    'Dus slide ka technical decision pack.',
  'Can you defend every major box and arrow?':
  ...
  'Add evaluation and observability':
    'Evaluation aur observability jodiye',
  'Turn the capstone into a measurable system.':
    'Capstone ko naapa ja sakne wala system banaiye.',
  'Every change should leave evidence.':
    'Har badlaav ko saboot chhod kar jaana chahiye.',
  'Create 30–50 evaluation cases and traces.':
    'Tees se pachaas evaluation case aur trace banaiye.',
  'Add retrieval, answer, tool, safety, latency and cost measurements.':
    'Retrieval, jawaab, tool, safety, latency aur lagat ki maap jodiye.',
  'Run a model/prompt/index change and reproduce the regression.':
    'Model, prompt ya index badal kar chalaiye aur giravat dobara paida kijiye.',
  'Golden dataset, evaluation harness and observability report.':
    'Golden dataset, evaluation harness aur observability ki report.',
  'Can you explain why the latest version is better?':
    'Kya aap bata sakte hain ki naya version behtar kyun hai?',
  'This is where the project becomes engineering evidence.':
    'Yahi woh jagah hai jahan project engineering ka saboot ban jaata hai.',
  'Break it deliberately':
    'Ise jaan-boojh kar todiye',
  'Reproduce at least ten failure classes.':
    'Kam se kam dus tarah ki galtiyan dobara paida kijiye.',
  'A portfolio project is more credible when you can explain what broke.':
    'Portfolio project tab zyada bharosemand hai jab aap bata sakein ki kya toota tha.',
  'Test unanswerable query, poisoned document, prompt injection, unauthorized tool, malformed tool call, stale permission, multilingual input, poor scan/audio, model swap and traffic/cost increase.':
    'Jaanchiye: jawaab-nahi wali query, zehar bhara document, prompt injection, bina ijaazat wala tool, bigdi hui tool call, purani permission, kai bhasha wala input, kharab scan ya audio, model badalna, aur traffic tatha lagat ka badhna.',
  'For each, capture evidence, root cause and control.':
    'Har ek ke liye saboot, mool kaaran aur control likhiye.',
  'Do not fix immediately; first preserve the failure.':
    'Turant mat sudhaariye; pehle galti ko sambhaal kar rakhiye.',
  'Security/red-team report + failure findings table.':
    'Security aur red-team ki report, aur galtiyon ki table.',
  'Which three failures surprised you?':
