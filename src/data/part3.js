...
window.PART3 = [
{
  ...
  story:[
    ...
    ['q','I049','I050'],
    ['do','Prove verbosity bias on your own judge',[
...
},
{
  ...
  capstone:{
    title:'The bill nobody has built yet',
    brief:'Everything in this chapter exists so you can answer a question most teams answer with a shrug: what does this feature cost at real volume, and what happens to the margin when it succeeds? Build it from measurements, not estimates.',
    steps:[
  ...
  story:[
    ...
    ['q','I100'],
    ['do','Build the bill, with the multipliers',[
...
},
{
  ...
  capstone:{
    title:'The corpus you can no longer trust',
    brief:'The failure in this chapter is silent: text that was never read correctly, answered confidently, with nothing anywhere reporting an error. Audit a real corpus and find out how much of it is quietly wrong.',
    steps:[
...
},
{
  ...
  capstone:{
    title:'The system card for something you own',
    brief:'Almost every question in the compliance folder turns out to be a product question wearing different clothes. Write the document that answers them for a real system — and prove the answers by exercising them rather than asserting them.',
    steps:[
...
},
{
  ...
  red:[],
  capstone:{
    title:'The spec that survives the model changing',
    brief:'An AI spec does not describe behaviour; it describes a measured range and what happens outside it. Write the real one for a feature you would ship, then rehearse the day the model underneath it changes.',
    steps:[
  ...
  story:[
    ...
    ['q','I109'],
    ['do','Design the feedback capture',[
