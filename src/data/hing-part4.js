...
Object.assign(window.HING = window.HING || {}, {
  ...
  'This is the single most common misdiagnosis in this field, and it is expensive exactly because the wrong answer sounds so reasonable.':
  ...
  '<strong>It cannot work it out.</strong> Several steps of logic, dependent arithmetic, genuine ambiguity. → Let it think, or use a stronger model (Chapter 11).':
    '<strong>Yeh nikaal nahi paata.</strong> Kai steps ka tark, aisa maths jahan har charan pichhle par tika ho, sach mein dhundhli baat. → Use sochne dijiye, ya mazboot model lijiye (Chapter 11).',
