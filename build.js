...
[ 'src/data/part1.js', 'src/data/part2.js', 'src/data/part3.js',
  'src/data/reference.js', 'src/data/skills.js',
  'src/data/items1.js', 'src/data/items2.js', 'src/data/items3.js',
  'src/data/work.js'
].forEach(f => { new Function('window', read(f))(sandbox.window); });

const W = sandbox.window;
const defaults = {
  chapters: [].concat(W.PART1, W.PART2, W.PART3),
  skills: W.SKILLS,
  items: [].concat(W.ITEMS1, W.ITEMS2, W.ITEMS3),
